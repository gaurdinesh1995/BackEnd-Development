...
export class UserController {
  ...
  static async sendResetPasswordEmail(req, res, next) {
    let email = req.query.email?.trim()?.toLowerCase(); // Normalize email
    ...
    try {
      ...
      // Send token in response or via email
      res.json({
        message: "Reset password token generated successfully.",
        reset_password_token: updatedUser.reset_password_token,
